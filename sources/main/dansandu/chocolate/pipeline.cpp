...
static constexpr auto defaultPerspectiveNear = 1.0;
static constexpr auto defaultPerspectiveFar = 1000.0;
static constexpr auto defaultPerspectiveFieldOfView = 1.92;
static constexpr auto defaultPerspectiveAspect = 1.0;
...
Pipeline& Pipeline::perspectiveProjection(const double near, const double far, const double fieldOfViewRadians,
                                          const double aspect)
{
